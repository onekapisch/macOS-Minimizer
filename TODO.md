...
- Add an About window with version, website, license, and credits.
- Add a Homebrew Cask after the first stable release.
- Test windows across Spaces, multiple displays, and fullscreen edge cases.
- Add an exclude-apps list in Settings.
